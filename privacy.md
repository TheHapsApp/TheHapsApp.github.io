...
- **City/area requests** — if you use "Request your city" in the app or on our website, the city or area you suggest we expand to, plus an _optional_ email if you ask to be notified when we launch there (never required). _Where:_ Supabase.
